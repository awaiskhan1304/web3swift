...
Pod::Spec.new do |spec|
    ...
    spec.homepage     = 'https://github.com/awaiskhan1304/web3swift'
    ...
    spec.source       = { :git => 'https://github.com/awaiskhan1304/web3swift', :branch => 'awais' }
    ...
    spec.dependency 'Web3Core', :git => 'https://github.com/awaiskhan1304/web3swift.git', :branch => 'awais'
end
